...
class FullRanet(tf.keras.Model):
    ...
    def build(self, input_shapes):
        ...
        self.output_3 = self.build_large_net(inputs=inputs, med_conv_1=self.med_1, med_conv_2=self.med_2,
                                             med_conv_3=self.med_3,
                                             med_conv_4=self.med_4)
    ...
    def build_med_net(self, inputs, small_conv_1, small_conv_2):
        ...
        #x = Conv2D(filters=64, kernel_size=(3, 3), padding='same', activation=None)(x)
        x = self.conv_in2(x)
        #temp = UpSampling2D(size=(2, 2), interpolation='bilinear')(small_conv_1) #upsamp lower conv
        ...
        #x = Conv2D(filters=64, kernel_size=(3, 3), padding='same', activation=None)(x)
        x = self.med_conv2(x)
        #temp = UpSampling2D(size=(2, 2), interpolation='bilinear')(small_conv_2)  # upsamp lower conv
    ...
    def build_large_net(self, inputs, med_conv_1, med_conv_2, med_conv_3, med_conv_4):
        ...
        #temp = UpSampling2D(size=(2, 2), interpolation='bilinear')(med_conv_1)  # upsamp lower conv
        ...
        #temp = UpSampling2D(size=(2, 2), interpolation='bilinear')(med_conv_2)  # upsamp lower conv
        ...
        #temp = UpSampling2D(size=(2, 2), interpolation='bilinear')(med_conv_3)  # upsamp lower conv
        ...
        #temp = UpSampling2D(size=(2, 2), interpolation='bilinear')(med_conv_4)  # upsamp lower conv
    ...
    def predict(self, x):
        ...
        if conf < self.threshold:
            ...
            if conf < self.threshold:
                output_3 = self.build_large_net(x, med_conv_1=med_1, med_conv_2=med_2, med_conv_3=med_3, med_conv_4=med_4)
...
# construct instance of FullRanet
# output_1, small_1, small_2 = FullRanet.build_small_net(inputs=inputs)
# output_2, med_1, med_2, med_3, med_4 = FullRanet.build_med_net(inputs=inputs, small_conv_1=small_1, small_conv_2=small_2)
# output_3 = FullRanet.build_large_net(inputs=inputs, med_conv_1=med_1, med_conv_2=med_2, med_conv_3=med_3, med_conv_4=med_4)
# model = FullRanet(inputs, [output_1, output_2, output_3])
model = FullRanet()
...
callback_list = [
    tf.keras.callbacks.ModelCheckpoint(
        ...
        save_weights_only=True, mode="auto", save_freq=100)
]
